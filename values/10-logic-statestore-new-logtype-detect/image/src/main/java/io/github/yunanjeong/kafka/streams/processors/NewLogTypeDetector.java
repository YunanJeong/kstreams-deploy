 ...
 *
 * 설정값(로그타입 필드명)은 생성자로 주입받는다. 환경변수 읽기는 호출측(TopologyMaker) 책임.
 */
public class NewLogTypeDetector implements Processor<String, JsonNode, String, JsonNode> {
    ...
    public static final String STORE_NAME = "logtype-first-seen-store";
    ...
    public NewLogTypeDetector(String logTypeField) {
     ...
     */
    public static ProcessorSupplier<String, JsonNode, String, JsonNode> supplier(String logTypeField) {
